...
//                mDetector.onTouchEvent(event);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                {
                    minimize();
                    findViewById(R.id.question_menu).setClickable(true);
                }
                return false;
    ...
    protected void onFinishInflate() {
        ...
        mDrawerView = findViewById(R.id.layout_detail);
//        mRotateView = findViewById(R.id.img_spread_out);

        findViewById(R.id.question_menu).setOnClickListener(v -> {
            maximize();
            findViewById(R.id.question_menu).setClickable(false);
        });
